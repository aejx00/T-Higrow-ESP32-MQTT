...
// deepsleep settings
// long sleepTime = 1800; // deep sleep in seconds
// bool running = false; // sleep toggle

int poll_interval = 3000; // millisecond delay to poll sensors

// soil probe tuning to get accurate saturation percentage
int dry = 3520; // default 3520
int wet = 1664; // default 1664
...
//MQTT credentials
const char* device_id = "soil_probe_1"; //used as mqtt_topic and hostname
...
#define DASH_BH1750_LUX_STRING          "BH1750 light intensity"
#define DASH_SOIL_VALUE_STRING          "Soil Saturation Value"
#define DASH_SALT_VALUE_STRING          "Salinity Value"
#define DASH_BATTERY_STRING             "Battery Voltage"
